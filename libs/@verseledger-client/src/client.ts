...
export function Environment(name: string): BaseURL {
  return `https://${name}-chdrs.encr.app`;
}
...
/**
 * Client is an API client for the chdrs Encore application.
 */
...
export namespace auth {
  ...
  export class ServiceClient {
    ...
    public async getServices(): Promise<{
      ...
      const resp = await this.baseClient.callTypedAPI('GET', `/api/v2/auth/services`);
    ...
    public async login(
      ...
      const resp = await this.baseClient.callTypedAPI(
        'POST',
        `/api/v2/auth/login/${encodeURIComponent(service)}`,
    ...
    public async whoami(): Promise<{
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI('POST', `/auth.whoami`);
      return (await resp.json()) as {
        data: user.User;
      };
    }
...
export namespace info {
  export class ServiceClient {
    ...
    public async get(): Promise<encore.dev.AppMeta> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI('GET', `/api/v2/info`);
...
export namespace users {
  export class ServiceClient {
    ...
    public async find(params: user.FindUsersCMD): Promise<{
      data: user.User[];
    }> {
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI('GET', `/api/v2/users`, undefined, {
        query,
      });
      return (await resp.json()) as {
        data: user.User[];
    ...
    public async get(user_id: string): Promise<{
      data: user.User;
    }> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        'GET',
        `/api/v2/users/${encodeURIComponent(user_id)}`,
      );
      return (await resp.json()) as {
        data: user.User;
      };
...
export namespace user_settings {
  export interface UpdateUserSettingCMD {
    id: string;
    key: string;
    value: string;
  }
  ...
  export class ServiceClient {
    ...
    public async get(): Promise<void> {
      await this.baseClient.callTypedAPI('GET', `/api/v2/settings`);
    }
...
export namespace waypoints {
  export interface CreateWaypointCMD {
    owner_id: utils.VerseID;
    parent_id?: utils.VerseID;
    name: string | null;
    public: boolean;
  ...
  export class ServiceClient {
    ...
    public async create(params: CreateWaypointCMD): Promise<{
      data: Waypoint;
    }> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
    ...
    public async listPublic(): Promise<{
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI('GET', `/waypoints/public`);
      return (await resp.json()) as {
        data: Waypoint[];
      };
    }
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (typeof window === 'undefined') {
      this.headers['User-Agent'] = 'chdrs-Generated-TS-Client (Encore/v1.46.3)';
    }
