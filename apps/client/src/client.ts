// Code generated by the Encore v1.46.0 client generator. DO NOT EDIT.
...
export namespace auth {
    ...
    data: LoginMethod[]
         ...
         */
        public async login(service: string, params: LoginWithServiceCMD): Promise<{
    data: VLTokenPair
}> {
            // Now make the actual call to the API
...
export namespace users {
    ...
    data: user.User[]
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/api/v2/users`, undefined, {query})
            return await resp.json() as {
    data: user.User[]
}
        }
...
export namespace waypoints {
    ...
    data: Waypoint
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/waypoints`, JSON.stringify(params))
            return await resp.json() as {
    data: Waypoint
}
        }
    ...
    data: Waypoint[]
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/waypoints/public`)
            return await resp.json() as {
    data: Waypoint[]
}
        }
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "chdrs-Generated-TS-Client (Encore/v1.46.0)";
        }
