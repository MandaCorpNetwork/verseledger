...
export const ContractDetails: React.FC<{
  ...
  return (
    ...
    >
      ...
      >
        <Box
          data-testid="CreateContract-ContractDetails-Form__LeftBox"
          sx={{ display: 'flex', flexDirection: 'column', gap: '1.8em' }}
        >
          <TextField
            data-testid="CreateContract-ContractDetails-Form__TitleField"
            label="Title"
          ...
          />
          <TextField
            data-testid="CreateContract-ContractDetails-Form__BriefingField"
            multiline={true}
            rows={4}
            onChange={(e) =>
        ...
        <Box data-testid="ContractDetails-Form__RightBox"></Box>
      </FormControl>
    </Box>
  );
};
