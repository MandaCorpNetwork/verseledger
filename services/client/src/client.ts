...
export function Environment(name: string): BaseURL {
    return `https://${name}-yy5oo.encr.app`
}
...
/**
 * Client is an API client for the yy5oo Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "yy5oo-Generated-TS-Client (Encore/v1.45.2)";
        }
