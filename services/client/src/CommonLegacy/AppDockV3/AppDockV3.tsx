...
import { LoginIcon } from '@CommonLegacy/AppDockV3/Buttons/LoginIcon';
import { MoreIcon } from '@CommonLegacy/AppDockV3/Buttons/MoreIcon';
import { SplashIcon } from '@CommonLegacy/AppDockV3/Buttons/SplashIcon';
import { UserStateIcon } from '@CommonLegacy/AppDockV3/Tools/UserStateIcon';
import { UserStateManager } from '@CommonLegacy/AppDockV3/Tools/UserStateManager';
import {
  useMasterAppList,
  VerseLedgerVersion,
...
const AppButtonV2 = React.lazy(async () => {
  const module = await import('@CommonLegacy/Components/Buttons/AppButtonV2');
