...
import SysCloseMp3 from '../../Assets/Sounds/Sys/sysClose.mp3?url';
import SysCloseWeb from '../../Assets/Sounds/Sys/sysClose.webm?url';
import SysHoverMp3 from '../../Assets/Sounds/Sys/sysHover.mp3?url';
import SysHoverWeb from '../../Assets/Sounds/Sys/sysHover.webm?url';
import SysNavigateMp3 from '../../Assets/Sounds/Sys/sysNavigate.mp3?url';
import SysNavigateWeb from '../../Assets/Sounds/Sys/sysNavigate.webm?url';
import SysOpenMp3 from '../../Assets/Sounds/Sys/sysOpen.mp3?url';
import SysOpenWeb from '../../Assets/Sounds/Sys/sysOpen.webm?url';
import SysPrimaryClickMp3 from '../../Assets/Sounds/Sys/sysPrimaryClick.mp3?url';
import SysPrimaryClickWeb from '../../Assets/Sounds/Sys/sysPrimaryClick.webm?url';
...
export const soundEffectPacks = {
  ...
  cnouPack: {
    name: 'CNOU Pack',
    pack: {
      close: soundEffectOptions.close[3].src,
      denied: soundEffectOptions.denied[2].src,
      error: soundEffectOptions.error[2].src,
      generalNotify: soundEffectOptions.generalNotify[2].src,
      loading: soundEffectOptions.loading[2].src,
      messageNotify: soundEffectOptions.messageNotify[2].src,
      navigate: soundEffectOptions.navigate[3].src,
      send: soundEffectOptions.send[2].src,
      success: soundEffectOptions.success[2].src,
      toggleOff: soundEffectOptions.toggleOff[2].src,
      toggleOn: soundEffectOptions.toggleOn[2].src,
      warning: soundEffectOptions.warning[2].src,
      hover: soundEffectOptions.hover[0].src,
      open: soundEffectOptions.open[3].src,
      clickMain: soundEffectOptions.clickMain[1].src,
    },
  },
  drakePack: {
    name: 'Drake Pack',
    pack: {
      close: soundEffectOptions.close[4].src,
      denied: soundEffectOptions.denied[3].src,
      error: soundEffectOptions.error[3].src,
      generalNotify: soundEffectOptions.generalNotify[3].src,
      loading: soundEffectOptions.loading[3].src,
      messageNotify: soundEffectOptions.messageNotify[3].src,
      navigate: soundEffectOptions.navigate[4].src,
      send: soundEffectOptions.send[3].src,
      success: soundEffectOptions.success[3].src,
      toggleOff: soundEffectOptions.toggleOff[3].src,
      toggleOn: soundEffectOptions.toggleOn[3].src,
      warning: soundEffectOptions.warning[3].src,
      hover: soundEffectOptions.hover[0].src,
      open: soundEffectOptions.open[4].src,
      clickMain: soundEffectOptions.clickMain[1].src,
    },
  },
  originPack: {
    name: 'Origin Pack',
    pack: {
      close: soundEffectOptions.close[5].src,
      denied: soundEffectOptions.denied[4].src,
      error: soundEffectOptions.error[4].src,
      generalNotify: soundEffectOptions.generalNotify[4].src,
      loading: soundEffectOptions.loading[4].src,
      messageNotify: soundEffectOptions.messageNotify[4].src,
      navigate: soundEffectOptions.navigate[5].src,
      send: soundEffectOptions.send[4].src,
      success: soundEffectOptions.success[4].src,
      toggleOff: soundEffectOptions.toggleOff[4].src,
      toggleOn: soundEffectOptions.toggleOn[4].src,
      warning: soundEffectOptions.warning[4].src,
      hover: soundEffectOptions.hover[0].src,
      open: soundEffectOptions.open[5].src,
      clickMain: soundEffectOptions.clickMain[1].src,
    },
  },
  rsiPack: {
    name: 'RSI Pack',
    pack: {
      close: soundEffectOptions.close[6].src,
      denied: soundEffectOptions.denied[5].src,
      error: soundEffectOptions.error[5].src,
      generalNotify: soundEffectOptions.generalNotify[5].src,
      loading: soundEffectOptions.loading[5].src,
      messageNotify: soundEffectOptions.messageNotify[5].src,
      navigate: soundEffectOptions.navigate[6].src,
      send: soundEffectOptions.send[5].src,
      success: soundEffectOptions.success[5].src,
      toggleOff: soundEffectOptions.toggleOff[5].src,
      toggleOn: soundEffectOptions.toggleOn[5].src,
      warning: soundEffectOptions.warning[5].src,
      hover: soundEffectOptions.hover[0].src,
      open: soundEffectOptions.open[6].src,
      clickMain: soundEffectOptions.clickMain[1].src,
    },
  },
};
